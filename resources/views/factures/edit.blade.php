...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Modifier une facture</h1>
        ...
        <form action="{{ route('factures.update', $facture->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="description" name="description" value="{{ $facture->description }}"
                    class="mt-1 block w-full p-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
                ...
                <input type="number" id="montant" name="montant" step="0.01" value="{{ $facture->montant }}"
                    class="mt-1 block w-full p-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
